...
public sealed record TelemetryHealthResponse
{
...
public sealed record MlBlockContract
{
    ...
    public List<ContributorContract> TopContributors { get; set; } = [];
}

public sealed record ModelInfoContract
{
...
public sealed record ContributorContract
{
