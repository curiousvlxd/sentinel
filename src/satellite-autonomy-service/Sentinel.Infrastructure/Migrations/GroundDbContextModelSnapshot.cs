...
internal partial class GroundDbContextModelSnapshot : ModelSnapshot
{
        ...
        modelBuilder.Entity("Sentinel.Core.Entities.SatelliteOperation", b =>
            {
                ...
                b.HasIndex("CommandTemplateId")
                    .HasDatabaseName("ix_commands_command_template_id");
        ...
        modelBuilder.Entity("Sentinel.Core.Entities.CommandTemplate", b =>
            {
                ...
                b.HasKey("Id")
                    .HasName("pk_command_templates");

                b.HasIndex("Type")
                    .IsUnique()
                    .HasDatabaseName("ix_command_templates_type");
        ...
        modelBuilder.Entity("Sentinel.Core.Entities.CommandTemplateField", b =>
            {
                ...
                b.HasKey("Id")
                    .HasName("pk_command_template_fields");

                b.HasIndex("CommandTemplateId")
                    .HasDatabaseName("ix_command_template_fields_command_template_id");
